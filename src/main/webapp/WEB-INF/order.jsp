...
<div class="container">
    ...
    <div>
        <form class="form-horizontal" role="form" action="<c:url value="/order"/>"
              method="post">
            <div class="row">
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        <c:forEach var="cartItem" items="${cart.cartItems}">
                            <li class="list-group-item d-fle justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <select class="custom-select d-block w-100" id="country" required name="country">
                                ...
                                <c:forEach var="country" items="${countries}">
                                    <option value="${country}" ${country == shippingAddress.country ? 'selected="selected"' : ''}>
                                        ${country}
                                    </option>
                                </c:forEach>
                            </select>
